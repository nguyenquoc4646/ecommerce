                ...
                <div class="row">
                    <div class="col-12">
                        <div class="row mb-2 mt-2 d-flex justify-between">
                            <div class="col-sm-6">
                                <h5>Cập nhật mã giảm : {{ $data->name }}</h5>
                            </div>
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="discountName" value="{{ old('discountName',$data->name) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="percen_amount" value="{{ old('percen_amount',$data->percen_amount) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="expire_date" value="{{ old('expire_date',$data->expire_date) }}"
                                                class="form-control">
